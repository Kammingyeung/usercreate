...
if __name__ == '__main__':
    ...
    permissions_list = [
        ("tt1", "dcc3608b-4941-442a-bced-2d569521380f"),
        ("tt2", "dcc3608b-4941-442a-bced-2d569521380s"),
    ]

    # 循环创建资产授权
    for name, user_uuid in permissions_list:
        create_asset_permission(jms_url, auth, name, user_uuid)